# PI-02-Metadata-Engine — Data Model

## Overview
Agent Runtime introduces the following data stores. Full DDL is in platform/shared/migrations/.
...
Agent Runtime-specific tables are defined in their respective migration files:
