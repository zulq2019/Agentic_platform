# PI-02-Metadata-Engine — Demo Script

**Audience:** Engineering team, PI stakeholders
**Duration:** 20 minutes
**Prerequisites:** Platform deployed to dev cluster with PI-01 through PI-02 active.

## Scene 1 — Happy Path (8 min)
Demonstrate the primary use case of Agent Runtime end-to-end.
...
- Show PI-02 acceptance criteria — all green
- Preview PI-3 objectives
