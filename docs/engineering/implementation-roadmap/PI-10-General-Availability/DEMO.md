# PI-10-General-Availability — Demo Script

**Audience:** Engineering team, PI stakeholders
**Duration:** 20 minutes
**Prerequisites:** Platform deployed to dev cluster with PI-01 through PI-10 active.

## Scene 1 — Happy Path (8 min)
Demonstrate the primary use case of General Availability end-to-end.
...
- Show PI-10 acceptance criteria — all green
- Preview PI-11 objectives
