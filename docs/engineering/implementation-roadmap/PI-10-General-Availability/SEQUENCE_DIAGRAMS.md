# PI-10-General-Availability — Sequence Diagrams
...
sequenceDiagram
    ...
    participant SVC as General Availability Service
...
See docs/architecture/REFERENCE_ARCHITECTURE.md for full platform-level sequence diagrams.
