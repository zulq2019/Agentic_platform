# PI-04-Workflow-Framework — Acceptance Criteria

## AC-PI-04-Workflow-Framework-01 — Functional
**Given** the platform spine (PI-01) is running,
**When** all Memory services start,
**Then** all health endpoints return 200 and all integration tests pass.

## AC-PI-04-Workflow-Framework-02 — Event Contract
...
## AC-PI-04-Workflow-Framework-03 — Tenant Isolation
