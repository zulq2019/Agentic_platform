# PI-04-Workflow-Framework — Demo Script

**Audience:** Engineering team, PI stakeholders
**Duration:** 20 minutes
**Prerequisites:** Platform deployed to dev cluster with PI-01 through PI-04 active.

## Scene 1 — Happy Path (8 min)
Demonstrate the primary use case of Memory end-to-end.
...
- Show PI-04 acceptance criteria — all green
- Preview PI-5 objectives
