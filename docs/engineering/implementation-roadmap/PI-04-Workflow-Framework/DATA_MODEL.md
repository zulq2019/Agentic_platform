# PI-04-Workflow-Framework — Data Model

## Overview
Memory introduces the following data stores. Full DDL is in platform/shared/migrations/.
...
Memory-specific tables are defined in their respective migration files:
