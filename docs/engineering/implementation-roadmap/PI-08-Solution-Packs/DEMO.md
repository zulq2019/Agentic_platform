# PI-08-Solution-Packs — Demo Script

**Audience:** Engineering team, PI stakeholders
**Duration:** 20 minutes
**Prerequisites:** Platform deployed to dev cluster with PI-01 through PI-08 active.

## Scene 1 — Happy Path (8 min)
Demonstrate the primary use case of Enterprise end-to-end.
...
- Show PI-08 acceptance criteria — all green
- Preview PI-9 objectives
