# PI-08-Solution-Packs — API Specification

## Services Introducing APIs in This PI
config-service :8115, auth-service :8081
...
|--------|------|---------|---------|
| See service source | src/api/ | config-service + multi-tenancy hardening across all services | See IMPLEMENTATION.md for design |
