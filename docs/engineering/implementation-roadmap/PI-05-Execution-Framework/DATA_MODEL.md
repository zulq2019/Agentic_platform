# PI-05-Execution-Framework — Data Model

## Overview
Tool Registry introduces the following data stores. Full DDL is in platform/shared/migrations/.
...
Tool Registry-specific tables are defined in their respective migration files:
