# PI-05-Execution-Framework — Demo Script

**Audience:** Engineering team, PI stakeholders
**Duration:** 20 minutes
**Prerequisites:** Platform deployed to dev cluster with PI-01 through PI-05 active.

## Scene 1 — Happy Path (8 min)
Demonstrate the primary use case of Tool Registry end-to-end.
...
- Show PI-05 acceptance criteria — all green
- Preview PI-6 objectives
