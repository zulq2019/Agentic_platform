# PI-07-Platform-Services — Demo Script

**Audience:** Engineering team, PI stakeholders
**Duration:** 20 minutes
**Prerequisites:** Platform deployed to dev cluster with PI-01 through PI-07 active.

## Scene 1 — Happy Path (8 min)
Demonstrate the primary use case of Governance end-to-end.
...
- Show PI-07 acceptance criteria — all green
- Preview PI-8 objectives
