# PI-07-Platform-Services — Data Model

## Overview
Governance introduces the following data stores. Full DDL is in platform/shared/migrations/.
...
Governance-specific tables are defined in their respective migration files:
