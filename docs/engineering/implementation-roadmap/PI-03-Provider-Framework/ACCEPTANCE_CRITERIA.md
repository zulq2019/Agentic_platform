# PI-03-Provider-Framework — Acceptance Criteria

## AC-PI-03-Provider-Framework-01 — Functional
**Given** the platform spine (PI-01) is running,
**When** all Orchestrator services start,
**Then** all health endpoints return 200 and all integration tests pass.

## AC-PI-03-Provider-Framework-02 — Event Contract
...
## AC-PI-03-Provider-Framework-03 — Tenant Isolation
