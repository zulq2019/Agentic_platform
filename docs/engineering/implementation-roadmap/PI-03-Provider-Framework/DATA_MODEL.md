# PI-03-Provider-Framework — Data Model

## Overview
Orchestrator introduces the following data stores. Full DDL is in platform/shared/migrations/.
...
Orchestrator-specific tables are defined in their respective migration files:
