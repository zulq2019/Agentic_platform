...
**Baseline:** [../architecture/ARCHITECTURE_BASELINE_V2.md](../architecture/ARCHITECTURE_BASELINE_V2.md)

---

## Architecture Baseline v2.0 milestone

**Completed (July 2026):** Architecture stabilisation before implementation resume — Platform Primitives, Contracts, Meta Model, UX Model, Glossary, philosophy whitepaper, Baseline v2, changelog, implementation readiness. See [../architecture/ARCHITECTURE_CHANGELOG_V2.md](../architecture/ARCHITECTURE_CHANGELOG_V2.md).
...
**Engineering alignment:** [ARCHITECTURE_ALIGNMENT_REPORT.md](../engineering/architecture-alignment/ARCHITECTURE_ALIGNMENT_REPORT.md) — PI-by-PI v2 classification, renamed capabilities, story impacts, and implementation order.
...
| [../architecture/ARCHITECTURE_BASELINE_V2.md](../architecture/ARCHITECTURE_BASELINE_V2.md) | Implementation baseline and gap register |
...
| [DECISIONS.md](../architecture/ADR/DECISIONS.md) | Decision records for roadmap changes |
