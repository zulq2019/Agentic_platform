...
**Philosophy:** [../architecture/METADATA_DRIVEN_ENTERPRISE_PLATFORM.md](../architecture/METADATA_DRIVEN_ENTERPRISE_PLATFORM.md)
...
| [../architecture/ARCHITECTURE_BASELINE_V2.md](../architecture/ARCHITECTURE_BASELINE_V2.md) | Metadata-driven enterprise ontology |
| [ARCHITECTURE.md](./ARCHITECTURE.md) | Technical realisation of this vision |
| [ROADMAP.md](docs/product/ROADMAP.md) | Phased delivery plan |
| [TASKS.md](./TASKS.md) | Engineering work breakdown |
| [DECISIONS.md](../architecture/ADR/DECISIONS.md) | Architectural decision records |
