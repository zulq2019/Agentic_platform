# PI-08-Enterprise — AI Implementation Prompts

Use these prompts when working with AI assistants to implement Enterprise.
Always attach CLAUDE.md and the relevant contract schemas as context.

## PROMPT-PI-08-Enterprise-01 — Core Service Implementation

```
Context files: CLAUDE.md, contracts/event-envelope.schema.json, ARCHITECTURE.md

Implement the Enterprise services for the Agentic Engineering Platform.

Services: config-service + multi-tenancy hardening across all services
...
## PROMPT-PI-08-Enterprise-02 — Integration Test

```
Context files: CLAUDE.md, existing test files in tests/integration/

Write an integration test for the primary event flow introduced in Enterprise.
...
## PROMPT-PI-08-Enterprise-03 — Observability

```
Add OpenTelemetry instrumentation to all Enterprise services.
