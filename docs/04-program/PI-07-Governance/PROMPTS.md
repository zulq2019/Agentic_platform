# PI-07-Governance — AI Implementation Prompts

Use these prompts when working with AI assistants to implement Governance.
Always attach CLAUDE.md and the relevant contract schemas as context.

## PROMPT-PI-07-Governance-01 — Core Service Implementation

```
Context files: CLAUDE.md, contracts/event-envelope.schema.json, ARCHITECTURE.md

Implement the Governance services for the Agentic Engineering Platform.

Services: policy-engine, audit-service, auth-service, rbac-service
...
## PROMPT-PI-07-Governance-02 — Integration Test

```
Context files: CLAUDE.md, existing test files in tests/integration/

Write an integration test for the primary event flow introduced in Governance.
...
## PROMPT-PI-07-Governance-03 — Observability

```
Add OpenTelemetry instrumentation to all Governance services.
