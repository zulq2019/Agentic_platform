# PI-09-Developer-Experience — Demo Script

**Audience:** Engineering team, PI stakeholders
**Duration:** 20 minutes
**Prerequisites:** Platform deployed to dev cluster with PI-01 through PI-09 active.

## Scene 1 — Happy Path (8 min)
Demonstrate the primary use case of Developer Experience end-to-end.
...
- Show PI-09 acceptance criteria — all green
- Preview PI-10 objectives
