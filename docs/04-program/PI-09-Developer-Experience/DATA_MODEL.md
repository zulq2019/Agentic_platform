# PI-09-Developer-Experience — Data Model

## Overview
Developer Experience introduces the following data stores. Full DDL is in platform/shared/migrations/.
...
Developer Experience-specific tables are defined in their respective migration files:
