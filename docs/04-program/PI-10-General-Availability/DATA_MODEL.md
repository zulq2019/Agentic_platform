# PI-10-General-Availability — Data Model

## Overview
General Availability introduces the following data stores. Full DDL is in platform/shared/migrations/.
...
General Availability-specific tables are defined in their respective migration files:
