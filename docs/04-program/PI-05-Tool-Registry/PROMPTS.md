# PI-05-Tool-Registry — AI Implementation Prompts

Use these prompts when working with AI assistants to implement Tool Registry.
Always attach CLAUDE.md and the relevant contract schemas as context.

## PROMPT-PI-05-Tool-Registry-01 — Core Service Implementation

```
Context files: CLAUDE.md, contracts/event-envelope.schema.json, ARCHITECTURE.md

Implement the Tool Registry services for the Agentic Engineering Platform.

Services: tool-registry, secrets-service, github-tool, jira-tool, confluence-tool
...
## PROMPT-PI-05-Tool-Registry-02 — Integration Test

```
Context files: CLAUDE.md, existing test files in tests/integration/

Write an integration test for the primary event flow introduced in Tool Registry.
...
## PROMPT-PI-05-Tool-Registry-03 — Observability

```
Add OpenTelemetry instrumentation to all Tool Registry services.
