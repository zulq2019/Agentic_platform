# PI-02-Agent-Runtime — AI Implementation Prompts

Use these prompts when working with AI assistants to implement Agent Runtime.
Always attach CLAUDE.md and the relevant contract schemas as context.

## PROMPT-PI-02-Agent-Runtime-01 — Core Service Implementation

```
Context files: CLAUDE.md, contracts/event-envelope.schema.json, ARCHITECTURE.md

Implement the Agent Runtime services for the Agentic Engineering Platform.

Services: agent-runtime, agent-registry, model-router, aep-agent-sdk
...
## PROMPT-PI-02-Agent-Runtime-02 — Integration Test

```
Context files: CLAUDE.md, existing test files in tests/integration/

Write an integration test for the primary event flow introduced in Agent Runtime.
...
## PROMPT-PI-02-Agent-Runtime-03 — Observability

```
Add OpenTelemetry instrumentation to all Agent Runtime services.
