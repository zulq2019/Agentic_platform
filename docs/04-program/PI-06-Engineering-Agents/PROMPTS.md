# PI-06-Engineering-Agents — AI Implementation Prompts

Use these prompts when working with AI assistants to implement Engineering Agents.
Always attach CLAUDE.md and the relevant contract schemas as context.

## PROMPT-PI-06-Engineering-Agents-01 — Core Service Implementation

```
Context files: CLAUDE.md, contracts/event-envelope.schema.json, ARCHITECTURE.md

Implement the Engineering Agents services for the Agentic Engineering Platform.

Services: 15 specialist agents (agents/ directory)
...
## PROMPT-PI-06-Engineering-Agents-02 — Integration Test

```
Context files: CLAUDE.md, existing test files in tests/integration/

Write an integration test for the primary event flow introduced in Engineering Agents.
...
## PROMPT-PI-06-Engineering-Agents-03 — Observability

```
Add OpenTelemetry instrumentation to all Engineering Agents services.
