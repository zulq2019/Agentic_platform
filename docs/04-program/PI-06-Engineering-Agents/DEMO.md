# PI-06-Engineering-Agents — Demo Script

**Audience:** Engineering team, PI stakeholders
**Duration:** 20 minutes
**Prerequisites:** Platform deployed to dev cluster with PI-01 through PI-06 active.

## Scene 1 — Happy Path (8 min)
Demonstrate the primary use case of Engineering Agents end-to-end.
...
- Show PI-06 acceptance criteria — all green
- Preview PI-7 objectives
