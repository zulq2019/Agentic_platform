# PI-06-Engineering-Agents — Data Model

## Overview
Engineering Agents introduces the following data stores. Full DDL is in platform/shared/migrations/.
...
Engineering Agents-specific tables are defined in their respective migration files:
