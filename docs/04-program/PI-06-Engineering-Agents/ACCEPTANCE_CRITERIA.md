# PI-06-Engineering-Agents — Acceptance Criteria

## AC-PI-06-Engineering-Agents-01 — Functional
**Given** the platform spine (PI-01) is running,
**When** all Engineering Agents services start,
**Then** all health endpoints return 200 and all integration tests pass.

## AC-PI-06-Engineering-Agents-02 — Event Contract
...
## AC-PI-06-Engineering-Agents-03 — Tenant Isolation
